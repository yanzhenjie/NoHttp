 ...
 * @author YOLANDA
 */
public class NoHttpImageActivity extends Activity implements OnResponseListener<Bitmap> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btn_reqeust_iamge).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Request<Bitmap> request = NoHttp.createImageRequest("http://img4.duitang.com/uploads/item/201403/14/20140314121845_efnHw.jpeg");
				CallServer.getInstance().add(0, request, NoHttpImageActivity.this);
			}
		});
