 ...
 * @author YOLANDA
 */
public class NoHttpCookieActivity extends Activity implements View.OnClickListener, OnResponseListener<String> {
	/**
	...
	public void onClick(View v) {
		...
		CallServer.getInstance().add(0, mRequest, this);
	}
