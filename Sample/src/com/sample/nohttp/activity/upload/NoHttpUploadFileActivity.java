 ...
 * @author YOLANDA
 */
public class NoHttpUploadFileActivity extends Activity implements View.OnClickListener, OnResponseListener<String> {
	...
	private void uploadFileNoHttp() {
		...
		CallServer.getInstance().add(0, request, this);
	}
