 ...
 * @author YOLANDA
 */
public class NoHttpMethodActivity extends Activity implements View.OnClickListener, OnResponseListener<String> {
	/**
	...
	public void onClick(View v) {
		...
		CallServer.getInstance().add(0, mRequest, this);// 这里的what，先用0代替，正式开发中，多个请求使用同一个Listener时，要传入不同的what，相当于handler的what一样
	}
