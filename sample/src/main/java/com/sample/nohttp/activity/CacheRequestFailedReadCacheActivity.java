...
public class CacheRequestFailedReadCacheActivity extends BaseActivity {
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        setTitle(Application.getInstance().cacheTitle[1]);
    ...
    private void requestString() {
        ...
        request.setCacheMode(CacheMode.REQUEST_FAILED_READ_CACHE);//设置为REQUEST_FAILED_READ_CACHE表示请求服务器失败，就返回上次的缓存，如果缓存为空才会请求失败
