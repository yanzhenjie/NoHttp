 ...
 * @author YOLANDA;
 */
public class CacheIfNoneRequestActivity extends BaseActivity {
    /**
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        setTitle(Application.getInstance().cacheTitle[2]);
    ...
    private void requestString() {
        ...
        request.setCacheMode(CacheMode.IF_NONE_CACHE_REQUEST);// 设置为IF_NONE_CACHE_REQUEST，代表如果缓存为空才请求服务器，否则返回缓存。
