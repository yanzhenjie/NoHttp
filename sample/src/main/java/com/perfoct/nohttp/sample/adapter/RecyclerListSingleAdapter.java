 ...
 */
package com.perfoct.nohttp.sample.adapter;
...
public class RecyclerListSingleAdapter extends BaseAdapter<RecyclerListSingleAdapter.TextViewHolder> {
    ...
    public TextViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new TextViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_title, parent, false));
    }
